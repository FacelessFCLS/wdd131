...
class Item(pygame.sprite.Sprite):
    def __init__(self, x, y, item_type, animation_list, dummy_coin = False):
        ...
        self.dummy_coin = dummy_coin #dummy coin to show score on panel, does not interact with player

    def update(self, screen_scroll, player, coin_fx, heal_fx):
        #doesn't apply to dummy coin on panel
        ...
        if self.rect.colliderect(player.rect):
            ...
            if self.item_type == 0:
                ...
                if player.health > 100:
                    player.health = 100
            self.kill() #remove item after it is picked up
